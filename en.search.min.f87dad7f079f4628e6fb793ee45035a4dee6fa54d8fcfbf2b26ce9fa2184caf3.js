...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/en.search-data.min.4994f8b8bafbb532de066f082f24f033a8bdccadd79a1decc050d3c50e5290ad.js',function(){input.required=false;search();});}
