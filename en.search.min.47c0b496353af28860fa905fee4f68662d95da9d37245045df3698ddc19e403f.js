...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/en.search-data.min.5897d795a87d965f052f0b96f83db9bfabcb1d7a44170cbd5308a6e9c33f9108.js',function(){input.required=false;search();});}
