...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/en.search-data.min.af2bbbe7ad8f4f7093e667d833ded62dafb656c78003d403f97d6265f21d713f.js',function(){input.required=false;search();});}
