...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/en.search-data.min.48f0ac2a89dda4b416da27f4923bba3d3282424a1bd5584853c091d65181b265.js',function(){input.required=false;search();});}
