...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/en.search-data.min.2d733ca2c0c311fa6a10bcfafab81af0b7c04f2f44d02da8073208a2da555778.js',function(){input.required=false;search();});}
